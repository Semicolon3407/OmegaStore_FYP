...
const SaleProductListing = () => {
  ...
  const fetchAllProducts = useCallback(async () => {
    try {
      ...
      setAllProducts(response.data.saleProducts || []);
    } catch (err) {
  ...
  const { categories, brands, colors, priceRange } = useMemo(() => {
    ...
    const prices = source.map((p) => p.salePrice);
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        >
          <div className="relative shadow-md rounded-full overflow-hidden bg-gray-200">
            ...
            <input
              type="text"
              placeholder="Search for sale products..."
              value={searchTerm}
              onChange={(e) => {
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">No sale products found</h3>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    We couldn't find any sale products matching your criteria. Try adjusting your filters.
                  </p>
                  <button
                    onClick={resetFilters}
                    className="bg-blue-900 text-white px-6 py-3 rounded-full hover:bg-blue-800 transition-all duration-300 shadow-md"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  {products.map((product) => (
                    ...
                    >
                      ...
                      <Link to={`/sale-products/${product._id}`} className="block">
...
export default SaleProductListing;