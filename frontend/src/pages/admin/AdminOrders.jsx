          ...
          <tbody>
            {orders.map((order) => (
              <motion.tr key={order.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                <td className="px-6 py-4">
                  <button onClick={() => handleEditOrder(order)} className="text-yellow-600 hover:text-yellow-800 mr-2">
                    <Edit2 size={20} />
                  </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg w-full max-w-md">
            ...
            <div className="mt-4 flex gap-2">
              <button onClick={handleUpdateOrder} className="bg-primary-600 text-white px-4 py-2 rounded hover:bg-primary-700">
                Update Order
              </button>
