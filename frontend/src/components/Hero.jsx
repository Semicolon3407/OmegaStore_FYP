...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-b from-gray-900 to-black text-white min-h-screen flex items-center overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-primary-900/10 via-transparent to-secondary-900/10 pointer-events-none"></div>
        <div className="absolute top-0 left-0 w-full h-full bg-[url('/assets/images/dot-pattern.png')] opacity-5 pointer-events-none"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center px-6 py-2.5 border border-white/30 rounded-full text-lg tracking-wider uppercase bg-gradient-to-r from-primary-600/20 to-secondary-600/20 backdrop-blur-sm shadow-lg"
            >
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-lg rounded-xl p-6 shadow-2xl border border-white/10 overflow-hidden relative"
            >
              {/* Glow effect */}
              <div className="absolute -top-20 -left-20 w-40 h-40 bg-primary-500 rounded-full filter blur-3xl opacity-20"></div>
              <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-secondary-500 rounded-full filter blur-3xl opacity-20"></div>
            ...
            >
              ...
              <Link
                to="/features"
                className="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden text-lg font-medium text-white rounded-full group border border-white/20 hover:border-white/40 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
          ...
          >
            <div className="relative w-full max-w-xl">
              {/* Phone Glow */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-primary-500/20 rounded-full filter blur-3xl -z-10"></div>
