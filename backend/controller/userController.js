...
const createUser = asyncHandler(async (req, res) => {
  try {
    ...
    if (findUser) {
      // If user exists, return a 400 error with a custom message
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Ensure isPasswordMatched exists
    if (!findUser.isPasswordMatched) {
      console.error("isPasswordMatched function is missing in User model.");
